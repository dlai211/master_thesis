...
% Examples:
\documentclass[dissertation, final, approved, atlas, copyright]{uothesis} % For final copies
...
\usepackage{tabularx,xspace,multirow,siunitx}
\usepackage{array}
\usepackage{atlasphysics}
\usepackage{xcolor}

%\makeatletter
%\def\pgfutil@unskip{\ifhmode\unskip\fi}
%\makeatother
